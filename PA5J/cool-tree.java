...
abstract class Expression extends TreeNode {
    ...
    public abstract void code(PrintStream s, CgenContext context);
...
class method extends Feature {
    ...
    /** Creates "method" AST node. 
      ...
      * @param lineNumber the line in the source file from which this node came.
      * @param a1 initial value for name
      * @param a2 initial value for formalcs
    ...
    public TreeNode copy() {
        return new method(lineNumber, copy_AbstractSymbol(name), (Formals)formalcs.copy(), copy_AbstractSymbol(return_type), (Expression)expr.copy());
    }
    public void dump(PrintStream out, int n) {
        out.print(Utilities.pad(n) + "method\n");
        dump_AbstractSymbol(out, n+2, name);
        formalcs.dump(out, n+2);
    ...
    public void dump_with_types(PrintStream out, int n) {
        ...
        dump_AbstractSymbol(out, n + 2, name);
        for (Enumeration e = formalcs.getElements(); e.hasMoreElements();) {
...
class formalc extends Formal {
    ...
    public void dump_with_types(PrintStream out, int n) {
        dump_line(out, n);
        out.println(Utilities.pad(n) + "_formalc");
        dump_AbstractSymbol(out, n + 2, name);
        dump_AbstractSymbol(out, n + 2, type_decl);
    }
